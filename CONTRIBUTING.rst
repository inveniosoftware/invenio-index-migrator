...
Invenio-Index-Migrator could always use more documentation, whether as part of the
official Invenio-Index-Migrator docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
https://github.com/inveniosoftware/invenio-index-migrator/issues.
...
3. The pull request should work for Python 2.7, 3.3, 3.4 and 3.5. Check
   https://travis-ci.org/inveniosoftware/invenio-index-migrator/pull_requests
